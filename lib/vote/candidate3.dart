...
class Candidate3Page extends StatefulWidget {
  @override
  _Candidate3PageState createState() => new _Candidate3PageState();
}

class _Candidate3PageState extends State<Candidate3Page> {
  @override
